...
[Opcode(CmdIds.NicknameModifyReq)]
public class HandlerNicknameModifyReq : Handler
{
    public override async Task OnHandle(Connection connection, byte[] header, byte[] data)
    {
        var req = NicknameModifyReq.Parser.ParseFrom(data);
        ...
        await connection.SendPacket(CmdIds.NicknameModifyRsp);
    }
}
